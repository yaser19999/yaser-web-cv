  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[url('/rose.svg')] bg-cover">
      ...
      <div className="  rounded-2xl text-[#b3cde4]  w-2/3  h-2/3 md:w-1/4">
        <form action={login} className="flex flex-col h-full justify-center gap-8 ">

          <div className="flex flex-col">
            <label htmlFor="email" className="md:text-xl">Email</label>
            <input type="email" name="email" id="email" className=" outline-none p-1 bg-[#b3cde4] rounded-2xl px-2 text-[#001b2e]" />
          </div>

          <div className="flex flex-col">
            <label htmlFor="password" className="md:text-xl" >Password</label>
            <input type="password" name="password" id="password" className=" outline-none bg-[#b3cde4] p-1 rounded-2xl px-2 text-[#001b2e]" />
          </div>
          ...
          <button className=" cursor-pointer py-2 px-5 bg-[#1d3f58] rounded-2xl hover:bg-[#eef3f9] hover:text-[#001b2e] transition-all duration-300">Login</button>
        </form>
      </div>
    </div>
  );
